...
public class ReplayManager : MonoBehaviour
{
    ...
    public enum Scene{indoor, outdoor};
    public Scene scene;
    [HideInInspector] 
    ...
    void Start()
    {
        ...
        // change data path to Application.dataPath + "/../resources/etdata/indoor" or outdoor depending on scene
        ...
        //extractDepthData.Initialize("test.bin");
    ...
    private void readFromCSV(string filename)
    {
        ...
        using (var reader = new StreamReader(filename))
        {
            ...
            while (!reader.EndOfStream)
            {
                ...
                // sicher dass camera pos und nicht eye origin?
                //Debug.Log("Camera Pos: " + cameraPos);
                //Debug.Log("Camera Rot: " + cameraRot);
                //Debug.Log("Combined Eye Gaze: " + combinedEyeG);
                
                Vector3 combinedEyeGazeC = cameraPos + cameraRot * combinedEyeG;
                combinedEyeGazeCamera.Add(combinedEyeGazeC);
                //Debug.Log("Combined Eye Gaze Camera: " + combinedEyeGazeC);
                //Debug.Log("--------------");
                ...
                //Debug.Log("Combined Eye Origin: " + combinedEyeO);
                //Debug.Log("Combined Eye Gaze: " + combinedEyeG);
            }
        }
    }
    ...
    private IEnumerator iterateOverFiles(){
        ...
        foreach (string file in files)
        {
            ...
            //extractDepthData.Dispose();

            //extractDepthData.Clear();
        }
    }
    ...
    private IEnumerator iterateOverCameraPositions(){
        ...
        for (int i = 0; i < cameraPositions.Count; i++)
        {
            ...
            //Vector3 pos = mainCamera.WorldToViewportPoint(targetPositions[i]);
            Vector3 pos = depthExtractionCamera.WorldToViewportPoint(targetPositions[i]);
            
            //Debug.Log("File Gaze: " + combinedEyeGazeCamera[i]);
            //Vector3 gaze = mainCamera.WorldToViewportPoint(combinedEyeGazeCamera[i]);
            Vector3 gaze = depthExtractionCamera.WorldToViewportPoint(combinedEyeGazeCamera[i]);
            //Debug.Log(".........");
            //Debug.Log("Target Pos: " + pos);
            //Debug.Log("Viewport Gaze: " + gaze);
            ...
            //camPosCounter = i;
            //Debug.Log("Saving depth texture " + i);

            

            //yield return new WaitForSeconds(0.2f);

            //yield return StartCoroutine(depthRecording.SaveDepthTex(sourceAcc));
